...
from .views import LandlordScheduleList,TenantScheduleList,AgentOpenRepairView,LandlordRepairHistoryView,LandlordMaintenanceServiceHistory,AgentMaintenanceView,TenantRepairHistoryView
urlpatterns =[
